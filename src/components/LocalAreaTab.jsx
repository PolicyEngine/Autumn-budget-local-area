  ...
  return (
    <div className="local-area-tab">
      ...
      <p className="dashboard-intro">
        Explore how the UK Autumn Budget 2025 affects households in your local area.
        Select your constituency and policies to see the impact on household incomes
        across different family types and income groups.{" "}
        <a
          href="#policy-details"
          onClick={(e) => {
            e.preventDefault();
